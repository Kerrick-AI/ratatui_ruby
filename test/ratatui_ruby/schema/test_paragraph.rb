...
class TestParagraph < Minitest::Test
  ...
  def test_paragraph_creation
    p = RatatuiRuby::Widgets::Paragraph.new(text: "Hello", fg: "red", bg: "black")
  ...
  def test_render
    with_test_terminal(20, 3) do
      p = RatatuiRuby::Widgets::Paragraph.new(text: "Hello World")
  ...
  def test_metrics_wrapped
    ...
    p = RatatuiRuby::Widgets::Paragraph.new(text: "Hello World", wrap: { trim: true })
  ...
  def test_metrics_cjk
    ...
    p_cjk = RatatuiRuby::Widgets::Paragraph.new(text: "あ")
